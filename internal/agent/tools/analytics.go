...
func RegisterAnalyticsTools(r *Registry, stats AttendanceStatsPort, userCross UserCrossPort) {
	registerQueryAttendanceStats(r, stats)
	registerQueryUserCross(r, userCross)
}
...
func registerQueryAttendanceStats(r *Registry, stats AttendanceStatsPort) {
	r.Register(ToolDef{
		Type: "function",
		Function: FunctionDef{
			...
			Parameters: json.RawMessage(`{
				...
				"properties": {
					...
					"dept_id":    {"type": "integer", "description": "按部门 ID 筛选"},
...
func registerQueryUserCross(r *Registry, userCross UserCrossPort) {
	r.Register(ToolDef{
		Type: "function",
		Function: FunctionDef{
			...
			Parameters: json.RawMessage(`{
				...
				"properties": {
					...
					"dept_id":    {"type": "integer", "description": "只在该部门内查找，0 或不填表示不限"},
